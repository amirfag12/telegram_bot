...
# ارسال جوک
jokes = [
    "رفتم داروخونه گفتم یه چیزی می‌خوام خستگی ذهنی‌مو در کنه، گفت تلگرامو پاک کن!",
    "معلم گفت چرا مشقتو ننوشتی؟ گفتم چون قلمم تموم شده، گفت چرا مداد استفاده نکردی؟ گفتم چون دروغ گفتم.",
    "یه بار خواستم مسئولیت‌پذیر باشم، همه چیز خراب شد، دیگه تکرار نمی‌کنم!",
    "قدیما یه چیزی گم می‌کردیم، مامانمون می‌گفت اگه از جات بلند شی پیداش می‌کنی. هنوز با همون روش دنبال آینده‌مم!",
    "پسرخالم می‌گه اگه آدم باهوشی بودی الان جای این جوکا برنامه‌نویسی می‌کردی!",
    "یه روز رفتم بانک گفتم وام می‌خوام، گفتن ضامن داری؟ گفتم نه ولی قول می‌دم که خوش‌حرفم!",
    "وقتی اینترنت قط میشه تازه می‌فهمم زندگیم چقدر بی‌محتواست!",
    "دوستم بهم گفت چرا نمی‌خندی؟ گفتم منتظر آپدیت زندگی‌مم!",
    "از وقتی فهمیدم کلاغا هم سن زیادی دارن، تصمیم گرفتم به تجربه‌شون گوش بدم!",
    "به مامانم گفتم رژیم گرفتم، گفت باشه ولی برنجتو تموم کن!"
]
