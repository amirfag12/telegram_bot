...
word_list = [
    ...
    'مرد', 'دست', 'تخت', 'طرح', 'حلزون', 'نقشه', 'هوا', 'باغ', 'گل',
    'لبخند', 'دانه', 'زمین', 'نارنج', 'جنگل', 'لباس', 'سیاره', 'رنگ', 'گوش',
    'شیر', 'ریشه', 'هشت', 'تار', 'رودخانه', 'نقاشی', 'یار', 'رئیس', 'ساعت',
    'تلویزیون', 'نارگیل', 'لب', 'برف', 'فنجان', 'نقاب', 'بام', 'مرداب', 'باد',
    'دریچه', 'همسایه', 'انگور', 'رام', 'ماه', 'هواپیما', 'اندازه', 'زمستان',
    'نسیم', 'میز', 'زنبور', 'رستوران', 'نان', 'نمک', 'کبریت', 'تلفن', 'نقش',
    'حیوان', 'نور', 'دل', 'باران', 'نام', 'موز', 'زمان', 'نماد', 'دما', 'آسمان',
    'هسته', 'سنگ', 'گنج', 'جاده', 'دریاچه', 'هرمز', 'زرد', 'دفتر', 'رنگین', 'نانوا',
    'تمرین', 'کوهستان', 'تنها', 'باد', 'یاد', 'دلبر', 'روز', 'زمزمه', 'انار', 'راز',
]
